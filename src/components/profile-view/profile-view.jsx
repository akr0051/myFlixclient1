...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios.get(`https://flixapp0051.herokuapp.com/users/${username}`, {
  ...
  deleteFavoriteMovie(movieId) {
    ...
    axios
      .delete(
        `https://flixapp0051.herokuapp.com/users/${localStorage.getItem(
          "user"
        )}/Movies/${movieId}`,
        {
  ...
  deleteUser(e) {
    axios
      .delete(
        `https://flixapp0051.herokuapp.com/users/${localStorage.getItem("user")}`,
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      )
